    ...
    <div className="flex flex-col min-h-screen bg-background pt-24">
      ...
      <section className="py-24 bg-background border-t border-border text-center">
        <div className="container mx-auto px-4">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] text-primary-foreground font-medium hover:opacity-90 transition-opacity mt-6 shadow-[0_4px_20px_rgba(99,102,241,0.25)]"
          >
            Get in touch
            <ArrowRight size={18} />
          </Link>
