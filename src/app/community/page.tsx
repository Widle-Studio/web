        ...
        <div className="container mx-auto px-4 max-w-[1000px] text-center relative z-10">
          ...
          <div className="flex justify-center gap-4">
             <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-border bg-foreground/5 text-foreground font-medium hover:bg-foreground/10 transition-colors"
            >
              View Retool Gallery
                  ...
                  <div className="mt-auto">
                    <div className="flex flex-wrap gap-2 mb-6">
                      {item.tags.map((tag, i) => (
                        <span
                          key={i}
                          className="px-2.5 py-1 bg-foreground/5 text-foreground/80 text-xs font-medium rounded-md border border-border"
                        >
                          {tag}
                        </span>
                      ))}
