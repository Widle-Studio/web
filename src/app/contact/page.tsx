...
export default function ContactPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0D0F14] pt-24 pb-32">
        ...
        <div className="container mx-auto px-4 max-w-[1200px]">
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#9CA3AF]">hello@autotech.agency</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#9CA3AF]">support@autotech.agency</p>
                  </div>
                </div>
            ...
            <div className="lg:w-7/12">
              <div className="bg-[#13161D] rounded-2xl border border-white/5 p-8 md:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full bg-[#0D0F14] border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#6366F1] focus:border-transparent transition-all placeholder:text-white/30"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full bg-[#0D0F14] border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#6366F1] focus:border-transparent transition-all appearance-none"
                        >
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="w-full bg-[#0D0F14] border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#6366F1] focus:border-transparent transition-all placeholder:text-white/30 resize-none"
                    ...
                    <button
                      ...
                      className="w-full py-4 rounded-lg bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] text-white font-medium hover:opacity-90 transition-opacity flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
      ...
      {/* Calendly Section */}
      <section className="py-24 border-t border-white/[0.06] bg-[#13161D]">
        <div className="container mx-auto px-4 max-w-[1000px] text-center">
           <h2 className="text-3xl font-bold text-white mb-6">
              Prefer to skip the form?
           </h2>
           <p className="text-[#9CA3AF] mb-12 max-w-xl mx-auto">
              Book a 30-minute discovery call directly on our calendar.
           </p>

           <div className="w-full bg-[#0D0F14] border border-white/10 rounded-2xl overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
             <InlineWidget
