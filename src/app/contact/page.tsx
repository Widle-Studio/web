...
export default function ContactPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background pt-24 pb-32">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full bg-background border border-border/50 rounded-lg px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-[#6366F1] focus:border-transparent transition-all placeholder:text-foreground/30"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full bg-background border border-border/50 rounded-lg px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-[#6366F1] focus:border-transparent transition-all appearance-none"
                        >
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="w-full bg-background border border-border/50 rounded-lg px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-[#6366F1] focus:border-transparent transition-all placeholder:text-foreground/30 resize-none"
      ...
      {/* Calendly Section */}
      <section className="py-24 border-t border-white/[0.06] bg-card">
        <div className="container mx-auto px-4 max-w-[1000px] text-center">
           ...
           <div className="w-full bg-background border border-border/50 rounded-2xl overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
             <InlineWidget
