              ...
              >
                ...
                <div className="w-full lg:w-1/2 flex flex-col space-y-8">
                  ...
                  <div className="pt-6 border-t border-border">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.tools.map((tool, i) => (
                        <span
                          key={i}
                          className="px-3 py-1 bg-foreground/5 border border-border rounded-md text-sm text-foreground/80"
                        >
                          {tool}
                        </span>
                      ))}
                  ...
                  <div className="flex flex-wrap gap-4 pt-4">
                    ...
                    <Link
                      href="/contact"
                      className="inline-flex items-center gap-2 text-muted-foreground font-medium border border-border bg-foreground/5 px-6 py-3 rounded-lg hover:bg-foreground/10 hover:text-foreground transition-colors w-fit"
                    >
