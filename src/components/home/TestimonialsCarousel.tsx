...
export default function TestimonialsCarousel() {
  ...
  return (
    <section className="py-24 md:py-32 bg-background overflow-hidden relative border-b border-border">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1000px] relative z-10 text-center">
        ...
        <div className="flex items-center justify-center gap-8 mt-12">
          <button
            onClick={prev}
            className="w-12 h-12 rounded-full bg-foreground/5 border border-border flex items-center justify-center text-foreground hover:bg-foreground/10 hover:border-border transition-all hover:scale-105"
