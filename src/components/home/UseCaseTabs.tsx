            ...
            {useCases
              ...
              .map((useCase) => (
                ...
                >
                  ...
                  <div className="relative rounded-xl bg-background border border-border/50 overflow-hidden flex items-center justify-center min-h-[300px] lg:min-h-full">
                    <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-[#22D3EE]/10 pointer-events-none" />
                    ...
                    <div className="w-[80%] h-[80%] flex flex-col gap-4 p-6 bg-card rounded-lg border border-border shadow-2xl relative z-10">
                      ...
                      <div className="flex gap-4 flex-1 mt-2">
                        ...
                        <div className="w-1/4 h-full flex flex-col gap-3">
                          ...
                          <div className="w-3/4 h-4 bg-muted rounded-md mt-4" />
                        ...
                        <div className="w-3/4 h-full flex flex-col gap-4">
                          <div className="flex justify-between items-center">
                            <div className="w-1/3 h-6 bg-muted/50 rounded-md" />
