  ...
  return (
    <section className="py-24 md:py-32 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1200px]">
        ...
        {/* Tab Content */}
        <div className="relative min-h-[500px] w-full rounded-2xl bg-card border border-border overflow-hidden">
                    ...
                    <div className="w-[80%] h-[80%] flex flex-col gap-4 p-6 bg-card rounded-lg border border-border shadow-2xl relative z-10">
                      ...
                      <div className="flex gap-4 flex-1 mt-2">
                        ...
                        <div className="w-1/4 h-full flex flex-col gap-3">
                          ...
                          <div className="w-3/4 h-4 bg-foreground/5 rounded-md mt-4" />
                          <div className="w-2/3 h-4 bg-foreground/5 rounded-md" />
                          <div className="w-4/5 h-4 bg-foreground/5 rounded-md" />
                        </div>
                        ...
                        <div className="w-3/4 h-full flex flex-col gap-4">
                          ...
                          <div className="grid grid-cols-3 gap-3 mb-2">
                            <div className="h-20 bg-foreground/5 rounded-md" />
                            <div className="h-20 bg-foreground/5 rounded-md" />
                            <div className="h-20 bg-foreground/5 rounded-md" />
                          </div>

                          <div className="flex-1 bg-foreground/5 rounded-md w-full" />
                        </div>
                      </div>
                    </div>
                  </div>
